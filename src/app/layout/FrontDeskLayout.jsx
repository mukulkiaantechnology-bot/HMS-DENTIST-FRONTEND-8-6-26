...
export function FrontDeskLayout({ children }) {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-background text-foreground select-none">
      {/* Sidebar (Desktop aside + Mobile bottom nav) */}
      <FrontDeskSidebar />
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 border-b border-border bg-card text-foreground px-4 sm:px-6 flex items-center justify-between z-20">
          <div className="flex items-center gap-3 flex-1">
            ...
            <div className="md:flex items-center gap-1.5 text-xs text-muted-foreground font-semibold hidden pl-2">
              ...
              <strong className="text-foreground">Vance Dental HQ</strong>
            </div>
          </div>
        ...
        {/* Scrollable Work Viewport (pb-16 on mobile to avoid covering by bottom nav bar) */}
