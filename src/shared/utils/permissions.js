export const MODULE_ROUTES = [
  ...
  // Clinic Owner Scoped Modules (Exactly 9 Modules)
  ...
  { module: 'clinic_appointments', path: '/clinic/appointments', label: 'Appointments', icon: 'Calendar' },
  ...
  { module: 'clinic_ai', path: '/clinic/ai', label: 'AI Insights', icon: 'Sparkles' },
