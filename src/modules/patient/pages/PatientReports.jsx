                ...
                {reports.map((xr) => {
                  ...
                  return (
                    <div
                      ...
                      className={`p-4 rounded-2xl border transition-all cursor-pointer text-xs font-semibold leading-normal ${
                        isSelected
              ...
              {selectedXray ? (
                <div className="bg-card border border-border rounded-2xl p-5 shadow-xs space-y-5">
                  ...
                  <div className="bg-slate-950 border border-slate-900 aspect-video rounded-xl relative overflow-hidden flex flex-col items-center justify-center p-6 shadow-inner select-none group">
                    ...
                    {/* Visual mockup of dental teeth X-Ray */}
                    <div className="relative z-0 opacity-80 flex gap-4 w-full h-full items-center justify-center filter saturate-0 contrast-150 brightness-75">
                      ...
                      {[1, 2, 3, 4, 5].map((index) => (
                        <div key={index} className="flex flex-col items-center gap-1.5">
                          ...
                          {/* Crown */}
                          <div className={`w-12 h-14 bg-slate-300 rounded-b-xl border-x border-b border-slate-950/45 shadow-sm relative flex items-center justify-center ${
                            selectedXray.id === 'xr-1' && index === 3 ? 'bg-rose-950/60 ring-2 ring-rose-500 ring-offset-1 ring-offset-slate-950 animate-pulse' : ''
                          }`}>
                  ...
                  <div className="relative z-10 flex justify-between">
                    {steps.map((step, idx) => (
                      <div key={idx} className="flex flex-col items-center text-center space-y-1.5 select-none">
                        <div
                          className={`w-6.5 h-6.5 rounded-full border-2 flex items-center justify-center font-bold text-[9px] transition-all ${
                            step.isActive
                        ...
                        <span
                          className={`text-[9px] uppercase tracking-wider font-extrabold ${
                            step.isActive ? 'text-primary' : step.isCompleted ? 'text-emerald-500' : 'text-muted-foreground'
                          }`}
                        >
                          {step.name}
                        </span>
