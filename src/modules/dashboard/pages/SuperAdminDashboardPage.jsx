...
export function SuperAdminDashboardPage() {
  ...
  const { clinics, auditLogs, toggleAiModule, updateSubscription, addClinic } = useSuperAdminStore();
  ...
  const chartData = useMemo(() => {
    ...
    return [
      { name: 'Jan', Revenue: 38400 },
      { name: 'Feb', Revenue: 41200 },
      { name: 'Mar', Revenue: 43500 },
      { name: 'Apr', Revenue: 45900 },
      { name: 'May', Revenue: 48800 },
