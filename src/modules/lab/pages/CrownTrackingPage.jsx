          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-card border border-border rounded-2xl p-5 shadow-sm space-y-4">
              ...
              <div className="p-4 bg-muted/40 border border-border rounded-xl space-y-3 text-xs leading-normal">
                <div className="flex justify-between"><span className="text-muted-foreground font-semibold">Patient Name:</span><span className="font-extrabold text-foreground">{activeCase.patientName}</span></div>
