...
export function LabCasesPage() {
  ...
  const handleCreateSubmit = (e) => {
    ...
    const newId = createLabCase({
      patientId,
      patientName: patientMap[patientId],
    ...
    toast.success(`Lab case ${newId} successfully created for ${patientMap[patientId]}!`);
                      ...
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            toast.info(`Switched focus to ${c.patientName}'s case.`);
                          }}
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="Create New Lab Case">
        <form onSubmit={handleCreateSubmit} className="space-y-4 text-xs font-semibold">
          <Select
            ...
            options={[
              { value: 'pat-1', label: 'James Carter (#pat-1)' },
              { value: 'pat-2', label: 'Mary Watson (#pat-2)' },
              { value: 'pat-3', label: 'Alex Johnson (#pat-3)' }
            ]}
          />
